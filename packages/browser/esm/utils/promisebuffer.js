    ...
    PromiseBuffer.prototype.add = function (task) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!this.isReady()) {
                    return [2, Promise.reject(new PartialError('Not adding Promise due to buffer limit reached.'))];
                }
                ...
                task
                    ...
                    return [2, this.remove(task)];
                }); }); })
                    .catch(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2, this.remove(task).catch(function () {
                            })];
                    });
                }); });
                return [2, task];
